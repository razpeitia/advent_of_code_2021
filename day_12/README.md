...
The solution is not trivial, it's relatively easy once you know [BFS](https://en.wikipedia.org/wiki/Breadth-first_search) or [DFS](https://en.wikipedia.org/wiki/Depth-first_search) algorithms.
In my case I went with BFS and some backtracking and my guess is that it would be way better with dfs.

Timing on `Intel(R) Core(TM) i7-9750H CPU @ 2.60GHz, 32GB DDR4 @ 2667MHz`

```
Part 1 took 6.261758ms
Part 1 took 141.048794ms
```
