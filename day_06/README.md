...
The solution is straight forward, just don't follow the way it suggest it and instead make an array from 0 to 8 (inclusive).
Then shift all numbers from 1 to 8 (inclusive) to 0 to 7. Set 8 to the numbers of 0's and add the numbers of 0's to 6.

Timing on `Intel(R) Core(TM) i7-9750H CPU @ 2.60GHz, 32GB DDR4 @ 2667MHz`

```
Part 1 took 22.718µs
Part 2 took 3.838µs
```
