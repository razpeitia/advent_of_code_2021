...
The solution for part 1 it was very easy, count the strings that have some lenghts and that's it.
As for part 2 it wasn't straight forward, but instead of going with per segment guess, I treated those strings as sets, play with the lenght and some intersection and union with `4`, `1` and `7` (actually with `issubset`).

With that said, I avoided some pain and wrote this on python.
