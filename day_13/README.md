...
The solution is not trivial, but not hard.
I don't know if it was coincidence but for day 13 my answer for part 1 was 666 :O

Timing on `Intel(R) Core(TM) i7-9750H CPU @ 2.60GHz, 32GB DDR4 @ 2667MHz`

```
Part 1 took 97.268µs
Part 2 took 325.204µs
```
