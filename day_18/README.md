...
Ok, it was hard to implement, the problem is not algorithmically challenging but rather a pain to implement all those requirements.

```
No timings, but it took a few seconds to run.
```