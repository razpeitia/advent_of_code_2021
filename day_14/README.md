...
It's lantern fish all over again!
Some tips:
- Use pairs instead of characters that will shave some effort.
- Just keep the count of the pairs and add the number of pairs that you had from the pair it generates it. (Just like in the larten fish day).
- You will end up with a bunch of duplication but that's fine, just divide that by 2.
- Add one to the answer (thrust me on this one).
...
Timing on `Intel(R) Core(TM) i7-9750H CPU @ 2.60GHz, 32GB DDR4 @ 2667MHz`
    ...
    Part 1 took 0.00028896331787109375 seconds
    Part 2 took 0.0012958049774169922 seconds
