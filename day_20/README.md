...
Well, I tried to be clever on this one, but I failed. The simple straight forward approach worked, but I had to rewrite almost all the code again.

Timing on `Intel(R) Core(TM) i7-9750H CPU @ 2.60GHz, 32GB DDR4 @ 2667MHz`

```
Part 1 took 6.661729ms
Part 2 took 624.796954ms
```
